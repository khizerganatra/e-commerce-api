...
console.log(products)
    ...
    categories.forEach(item => {
        let btn = `<button class="btn btn-warning  ctg-btn" onClick="ctgBtn(this)" value=${item}>${item}</button>`
        document.getElementById("categories").innerHTML += btn;
    })

    products.forEach(product => {
        let card = `<div data-aos="fade-up"
        data-aos-duration="3000" class="card m-5 col-12 col-md-6 col-lg-4 col-xl-3" style="width: 18rem;">
